...
from lazy_wifi.configurations.context import Context, ConfigurationException
...
class AttackConfig:
    ...
    def setup(self):
        ...
        try:
            ...
            num_deauth_packets = int(self.current_config_section.get('num_deauth_packets'))
            ...
            target_list = ast.literal_eval(self.current_config_section.get('target_ssid_list'))
